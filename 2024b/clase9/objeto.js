...
class Objeto {
  ...
  cambiarSprite(cual, numero = 0, loop = true, cb) {
    // console.log("#cambiarSprite", cual, numero)
  ...
  cargarSpriteSheetAnimadoDeJSON(url, cb) {
    ...
    PIXI.Assets.load("./img/ambulancia.json").then(e=>{
      this.sheet = e
